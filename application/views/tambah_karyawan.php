					 		...
					 		<fieldset>
					 			...
					 			<div class="form-group">
					 				<select class="form-control" name="pangkat_golongan" required>
					 					...
					 					foreach ($query->result() as $key => $value) {
					 						if($value->pangkat_golongan == $_POST["pangkat_golongan"])
					 						{
					 							$selected = "selected";
					 						}else
					 						{
					 			...
					 			<div class="form-group">
					 				<input class="form-control datepicker" type="" name="tmt_golongan" required placeholder="Tmt Golongan" value="<?php echo $_POST["tmt_golongan"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="sk_pengangkatan_awal" required placeholder="Sk Pengangkatan Awal" value="<?php echo $_POST["sk_pengangkatan_awal"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control tmt_pengangkatan_awal" type="" name="tmt_pengangkatan_awal" placeholder="Tmt pengangkatan awal" required value="<?php echo $_POST["tmt_pengangkatan_awal"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="mengampu_mata_pelajaran" placeholder="Mengampu Mata Pelajaran" required value="<?php echo $_POST["mengampu_mata_pelajaran"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="number" name="jumlah_jam_mengajar" placeholder="Jumlah Jam Mengajar, ex: 24" required max="24" value="<?php echo $_POST["jumlah_jam_mengajar"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="pejabat_yang_mengangkat" placeholder="Pejabat Yang Mengangkat" required  value="<?php echo $_POST["pejabat_yang_mengangkat"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_sk_cpns" placeholder="No Sk CPNS" required  value="<?php echo $_POST["no_sk_cpns"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control datepicker" type="" name="tmt_sk_cpns" placeholder="Tmt Sk CPNS" required value="<?php echo $_POST["tmt_sk_cpns"];?>" >
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_sk_pns" placeholder="NO SK PNS" required value="<?php echo $_POST["no_sk_cpns"];?>" >
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control datepicker" type="" name="tmt_sk_pns" placeholder="TMT SK PNS" required  value="<?php echo $_POST["tmt_sk_pns"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_sk_pangkat_terakhir" placeholder="No Sk Pangkat Terakhir" required  value="<?php echo $_POST["no_sk_pangkat_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control datepicker" type="" name="tmt_sk_pangkat_terakhir" placeholder="Tmt Sk Pangkat Terakhir" required  value="<?php echo $_POST["tmt_sk_pangkat_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_nuptk" placeholder="No Nuptk (Jika Tidak Punya Isi '-')" required max="16" value="<?php echo $_POST["no_nuptk"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_karpeg" placeholder="No Karpeg" required  value="<?php echo $_POST["no_karpeg"];?>">
					 			</div>
					 			<div class="form-group">
					 				<select class="form-control" name="jabatan" required>
					 					...
					 					foreach ($query->result() as $key => $value) {
					 						if($value->jabatan == $_POST["jabatan"])
					 						{
					 							$selected = "selected";
					 						}else
					 						{
					 			...
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="unit_kerja" placeholder="Unit Kerja" required   value="<?php echo $_POST["unit_kerja"];?>">
					 			</div>
					 			<div class="form-group">
					 				<select class="form-control sk_pengangkatan_jabatan_fungsional_tertentu" name="sk_pengangkatan_jabatan_fungsional_tertentu" required>
					 					...
					 					foreach ($query->result() as $key => $value) {
					 						if($value->sk_pengangkatan_jabatan_fungsional_tertentu == $_POST["sk_pengangkatan_jabatan_fungsional_tertentu"])
					 						{
					 							$selected = "selected";
					 						}else
					 						{
					 			...
					 			<div class="form-group">
					 				<input  class="form-control datepicker" type="" name="tmt_jabatan" placeholder="Tmt Jabatan" required  value="<?php echo $_POST["tmt_jabatan"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="masa_kerja_terakhir" placeholder="Masa Kerja Terakhir" value="8 Tahun 1 Bulan" required  value="<?php echo $_POST["masa_kerja_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control masa_kerja_pengangkatan" type="" name="masa_kerja_pengangkatan" placeholder="Masa Kerja Pengangkatan" required  value="<?php echo $_POST["masa_kerja_pengangkatan"];?>">
					 			</div>
					 			<div class="form-group">
					 				<label>Tahun Pensiun
						 				<input  class="form-control tahun_pensiun" type="" name="tahun_pensiun" placeholder="Tahun Pensiun" required  value="<?php echo $_POST["tahun_pensiun"];?>">
					 				</label>
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control gaji_terakhir" type="" name="gaji_terakhir" placeholder="Gaji Terakhir" required  value="<?php echo $_POST["gaji_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<select class="form-control" name="sertifikasi" required>
					 					...
					 					foreach ($query->result() as $key => $value) {
					 						if($value->sertifikasi == $_POST["sertifikasi"])
					 						{
					 							$selected = "selected";
					 						}else
					 						{
					 			...
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_sertifikasi" placeholder="No Sertifikasi" required  value="<?php echo $_POST["no_sertifikasi"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="berkala_terakhir" placeholder="Berkala Terakhir" required value="<?php echo $_POST["berkala_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="tahun_sertifikasi" placeholder="Tahun Sertifikasi" required value="<?php echo $_POST["tahun_sertifikasi"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="berkala_terakhir" placeholder="Berkala Terkahir" required  value="<?php echo $_POST["berkala_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_berkala_terakhir" placeholder="No Berkala Terkahir" required value="<?php echo $_POST["no_berkala_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="tanggal_berkala_berikutnya" placeholder="Tanggal Berkala Berikutnya" required value="<?php echo $_POST["tanggal_berkala_berikutnya"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="" name="no_berkala_berikutnya" placeholder="No Berkala Berikutnya (isi dgn '-')" required value="<?php echo $_POST["no_berkala_berikutnya"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input  class="form-control" type="number" name="no_hp" placeholder="No Hp" required value="<?php echo $_POST["no_hp"];?>">
					 			</div>
					 		</fieldset>
			 			</div>
					 		...
					 		<fieldset>
					 			...
					 			<div class="form-group">
					 				<select class="form-control" name="pendidikan_terakhir">
					 					...
					 					foreach ($query->result() as $key => $value) {
											if($value->pendidikan_terakhir == $_POST["pendidikan_terakhir"])
					 						{
					 							$selected = "selected";
					 						}else
					 						{
					 			...
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="no_ijazah_terakhir" placeholder="No Ijazah Terakhir" value="<?php echo $_POST["no_ijazah_terakhir"];?>">
					 			</div>
					 			<div class="form-group">
					 				<label>
					 			...
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="universitas" placeholder="Universitas" value="<?php echo $_POST["universitas"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="fakultas" placeholder="Fakultas" value="<?php echo $_POST["fakultas"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="jurusan" placeholder="Jurusan" value="<?php echo $_POST["jurusan"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control"  type="number" name="tahun_lulus" placeholder="Tahun Lulus" required value="<?php echo $_POST["tahun_lulus"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="riwayat_pendidikan_sd" placeholder="Riwayat Pendidikan Sd" required value="<?php echo $_POST["riwayat_pendidikan_sd"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="no_ijazah_sd" placeholder="No Ijazah Sd" required value="<?php echo $_POST["no_ijazah_sd"];?>">
					 			</div>
					 			<div class="form-group">
					 				<label>Ijazah Sd:
					 			...
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="riwayat_pendidikan_smp" placeholder="Riwayat Pendidikan SMP" required placeholder="Riwayat Pendidikan SMP" value="<?php echo $_POST["riwayat_pendidikan_smp"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="no_ijazah_smp" placeholder="No Ijazah SMP" required value="<?php echo $_POST["no_ijazah_smp"];?>">
					 			</div>
					 			<div class="form-group">
					 				<label>
					 					Ijazah Smp: 
					 			...
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="riwayat_pendidikan_sma" placeholder="Riwayat Pendidikan SMA/SMK" required value="<?php echo $_POST["riwayat_pendidikan_sma"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control"  type="" name="no_ijazah_sma" placeholder="No Pendidikan SMA/SMK" required value="<?php echo $_POST["no_ijazah_sma"];?>">
					 			</div>
					 			<div class="form-group">
					 				<label>
					 					Ijazah Sma: 
					 		...
					 		<fieldset>
					 			...
					 			<div class="form-group">
					 				<select class="form-control" name="status_perkawinan" required>
					 					...
					 					foreach ($query->result() as $key => $value) {
					 						if($value->status_perkawinan == $_POST["status_perkawinan"])
					 						{
					 							$selected = "selected";
					 						}else
					 						{
					 			...
					 			<div class="form-group">
					 				<input class="form-control" type="" name="nama_suami_istri" required placeholder="Nama Suami / Istri" value="<?php echo $_POST["nama_suami_istri"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="nik_suami_istri" required placeholder="Nik Suami Atau Istri 16 digit" value="<?php echo $_POST["nik_suami_istri"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="jumlah_anak" required placeholder="Jumlah Anak" value="<?php echo $_POST["jumlah_anak"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="nama_anak_pertama" required placeholder="Nama Anak Pertama" value="<?php echo $_POST["nama_anak_pertama"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="nik_anak_pertama" required placeholder="Nik Anak Pertama 16 digit" value="<?php echo $_POST["nik_anak_pertama"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="nama_anak_kedua" required placeholder="Nama Anak Kedua" value="<?php echo $_POST["nama_anak_kedua"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="nik_anak_kedua" required placeholder="Nik Anak Kedua" value="<?php echo $_POST["nik_anak_kedua"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="nama_anak_ketiga" required placeholder="Nama Anak Ketiga" value="<?php echo $_POST["nama_anak_ketiga"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="nik_anak_ketiga" required placeholder="Nik Anak Ketiga" value="<?php echo $_POST["nik_anak_ketiga"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="nama_ayah_kandung" required placeholder="Nama Ayah Kandung" value="<?php echo $_POST["nama_ayah_kandung"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="nik_ayah_kandung" required placeholder="Nik Ayah Kandung" value="<?php echo $_POST["nik_ayah_kandung"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="nama_ibu_kandung" required placeholder="Nama Ibu Kandung" value="<?php echo $_POST["nama_ibu_kandung"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="nik_ibu_kandung" required placeholder="Nik Ibu Kandung" value="<?php echo $_POST["nik_ibu_kandung"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="pekerjaan_suami_istri" required placeholder="Pekerjaan Suami Atau Istri" value="<?php echo $_POST["pekerjaan_suami_istri"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="nip_suami_istri" required placeholder="Nip Suami Atau Istri (18 angka jika tidak punya isi '-')" value="<?php echo $_POST["nip_suami_istri"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control penghasilan_suami_istri" type="" name="penghasilan_suami_istri" required placeholder="Penghasilan Suami Istri" value="<?php echo $_POST["penghasilan_suami_istri"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="alamat_rumah" required placeholder="Alamat Rumah" value="<?php echo $_POST["alamat_rumah"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="desa_kelurahan" required placeholder="Desa Atau Kelurahan" value="<?php echo $_POST["desa_kelurahan"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="kecamatan" required placeholder="Kecamatan" value="<?php echo $_POST["kecamatan"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="kabupaten" required placeholder="Kabupaten" value="<?php echo $_POST["kabupaten"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="" name="provinsi" required placeholder="Provinsi" value="<?php echo $_POST["provinsi"];?>">
					 			</div>
					 			<div class="form-group">
					 				<input class="form-control" type="number" name="kode_pos" required placeholder="Kode Pos" value="<?php echo $_POST["kode_pos"];?>">
					 			</div>
					 		</fieldset>
			 			</div>
					</div>
			 			...
			 			<div class="col-md-12 data_sekolah">
					 		<fieldset>
								...
								<div class="row">
									<div class="col-md-6">
							 			<div class="form-group">
							 				<input class="form-control" type="" name="unit_kerja" placeholder="Unit Kerja" value="<?php echo $_POST["unit_kerja"];?>">
							 			</div>
							 			<div class="form-group">
							 				<select class="form-control" name="jenjang_sekolah" required>
							 					...
							 					foreach($query->result() as $key => $value)
							 					{
							 						if($value->jenjang_sekolah == $_POST["jenjang_sekolah"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<input class="form-control" type="" name="nama_sekolah" required placeholder="Nama Sekolah" value="<?php echo $_POST["nama_sekolah"];?>">
							 			</div>
							 			<div class="form-group">
							 			...
							 			<div class="form-group">
							 				<input class="form-control" type="" name="nama_kepala_sekolah" placeholder="Nama Kepala Sekolah" value="<?php echo $_POST["nama_kepala_sekolah"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="nip_nama_kepala_sekolah" placeholder="Nip Nama Kepala Sekolah (18 angka jika tidak punya isi '-'" minlength="18" value="<?php echo $_POST["nip_nama_kepala_sekolah"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="tempat_lahir_kepala_sekolah" placeholder="Tempat Lahir Kepala Sekolah" value="<?php echo $_POST["tempat_lahir_kepala_sekolah"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control datepicker" type="" name="tanggal_lahir_kepala_sekolah" placeholder="Tanggal Lahir Kepala Sekolah" value="<?php echo $_POST["tanggal_lahir_kepala_sekolah"];?>">
							 			</div>
							 			<div class="form-group">
							 				<select class="form-control" name="jenis_kelamin_kepala_sekolah" required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->jenis_kelamin == $_POST["jenis_kelamin_kepala_sekolah"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control" name="pendidikan_terakhir_kepala_sekolah" required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->pendidikan_terakhir == $_POST["pendidikan_terakhir_kepala_sekolah"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<input class="form-control" type="" name="tmt_kepala_sekolah_periode_pertama" placeholder="Tmt Kepala Sekolah Periode Pertama" value="<?php echo $_POST["tmt_kepala_sekolah_periode_pertama"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="tmt_kepala_sekolah_periode_kedua" placeholder="Tmt Kepala Sekolah Periode Kedua" value="<?php echo $_POST["tmt_kepala_sekolah_periode_kedua"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="tmt_kepala_sekolah_periode_ketiga" placeholder="Tmt Kepala Sekolah Periode Ketiga" value="<?php echo $_POST["tmt_kepala_sekolah_periode_ketiga"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="no_sk_kepala_sekolah_pertama" placeholder="No Sk Kepala Sekolah Pertama" value="<?php echo $_POST["no_sk_kepala_sekolah_pertama"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="no_sk_kepala_sekolah_kedua" placeholder="No Sk Kepala Sekolah Kedua" value="<?php echo $_POST["no_sk_kepala_sekolah_kedua"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="no_sk_kepala_sekolah_ketiga" placeholder="No Sk Kepala Sekolah Ketiga" value="<?php echo $_POST["no_sk_kepala_sekolah_ketiga"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="no_sertifikat_nuk" placeholder="No Sertifikat Nuk" value="<?php echo $_POST["no_sertifikat_nuk"];?>">
							 			</div>
							 			<div class="form-group">
							 				<label>
							 					Dokumen Nuk: 
							 			...
							 			<div class="form-group">
							 				<select class="form-control" name="akreditasi_sekolah" required>
							 					...
							 					foreach ($query->result() as $key => $value) {
													if($value->akreditasi_sekolah == $_POST["akreditasi_sekolah"])
													{
														$selected = "selected";
													}else
													{
							 			...
							 			<div class="form-group">
							 				<input class="form-control" type="" name="nss" placeholder="Nss" value="<?php echo $_POST["nss"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="npsn" placeholder="Npsn" value="<?php echo $_POST["npsn"];?>">
							 			</div>
							 			<div class="form-group">
							 				<select class="form-control" name="status_sekolah">
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->status_sekolah == $_POST["status_sekolah"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_rombel" placeholder="Jumlah Rombel" value="<?php echo $_POST["jumlah_rombel"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_tenaga_pengajar" placeholder="Jumlah Tenaga Pengajar" value="<?php echo $_POST["jumlah_tenaga_pengajar"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_siswa_laki_laki" placeholder="Jumlah Siswa Laki-Laki" value="<?php echo $_POST["jumlah_siswa_laki_laki"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_siswa_perempuan" placeholder="Jumlah Siswa Perempuan" value="<?php echo $_POST["jumlah_siswa_perempuan"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_siswa_keseluruhan" placeholder="Jumlah Siswa Keseluruhan" value="<?php echo $_POST["jumlah_siswa_keseluruhan"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="kebutuhan_guru" placeholder="Kebutuhan Guru" value="<?php echo $_POST["kebutuhan_guru"];?>">
							 			</div>
									</div>
									<div class="col-md-6">
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="guru_yang_tersedia" placeholder="Guru Yang Tersedia" value="<?php echo $_POST["guru_yang_tersedia"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="kekurangan_guru" placeholder="Kekurangan Guru" value="<?php echo $_POST["kekurangan_guru"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="kelebihan_guru" placeholder="Kelebihan Guru" value="<?php echo $_POST["kelebihan_guru"];?>">
							 			</div>
							 			<div class="form-group">
							 				<select class="form-control" name="ruang_keterampilan" required value="<?php echo $_POST["ruang_keterampilan"];?>">
							 					<option value="">--Ruang Keterampilan--</option>
							 					<?php 
							 					$query = $this->db->query("select * from tbl_ada_tidak");

							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["ruang_keterampilan"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control"  name="lab_bahasa" required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["lab_bahasa"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control"  name="lab_komputer" required>
												...
												<?php 
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["lab_komputer"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control"  name="lab_ipa"  required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["lab_ipa"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control"  name="perpustakaan"  required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["perpustakaan"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control"  name="ruang_kelas"  required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["ruang_kelas"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control"  name="kondisi_ruangan"  required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["kondisi_ruangan"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<select class="form-control"  name="alat_pembelajaran"  required>
							 					...
							 					foreach ($query->result() as $key => $value) {
							 						if($value->ada_tidak == $_POST["alat_pembelajaran"])
							 						{
							 							$selected = "selected";
							 						}else
							 						{
							 			...
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_matematika" placeholder="Jumlah Guru Matematika" value="<?php echo $_POST["jumlah_guru_matematika"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_ipa" placeholder="Jumlah Guru Ipa" value="<?php echo $_POST["jumlah_guru_ipa"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_ips"  placeholder="Jumlah Guru Ips" value="<?php echo $_POST["jumlah_guru_ips"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_sbk"  placeholder="Jumlah Guru Sbk" value="<?php echo $_POST["jumlah_guru_sbk"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_bahasa_indonesia" placeholder="Jumlah Guru Bahasa Indonesia" value="<?php echo $_POST["jumlah_guru_bahasa_indonesia"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_bahasa_inggris" placeholder="Jumlah Guru Bahasa Inggris" value="<?php echo $_POST["jumlah_guru_bahasa_inggris"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_pjok" placeholder="Jumlah Guru Pjok" value="<?php echo $_POST["jumlah_guru_pjok"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_pkn" placeholder="Jumlah Guru Pkn" value="<?php echo $_POST["jumlah_guru_pkn"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_prakarya" placeholder="Jumlah Guru Prakarya" value="<?php echo $_POST["jumlah_guru_prakarya"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_agama_islam" placeholder="Jumlah Guru Agama Islam" value="<?php echo $_POST["jumlah_guru_agama_islam"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_agama_katolik" placeholder="Jumlah Guru Agama Katolik" value="<?php echo $_POST["jumlah_guru_agama_katolik"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_agama_protestan"  placeholder="Jumlah Guru Agama Protestan" value="<?php echo $_POST["jumlah_guru_agama_protestan"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_agama_budha" placeholder="Jumlah Guru Agama Budha" value="<?php echo $_POST["jumlah_guru_agama_budha"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_guru_agama_hindu"  placeholder="Jumlah Guru Agama Hindu" value="<?php echo $_POST["jumlah_guru_agama_hindu"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_pns"  placeholder="Jumlah Pns" value="<?php echo $_POST["jumlah_pns"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_gty" placeholder="Jumlah Gty" value="<?php echo $_POST["jumlah_gty"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_gtk"  placeholder="Jumlah Gtk" value="<?php echo $_POST["jumlah_gtk"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_gtt"  placeholder="Jumlah Gtt" value="<?php echo $_POST["jumlah_gtt"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="number" name="jumlah_gdd" placeholder="Jumlah Gdd" value="<?php echo $_POST["jumlah_gdd"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="kepala_dinas_sekarang" placeholder="Kepala Dinas Sekarang" value="<?php echo $_POST["kepala_dinas_sekarang"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="nip_kepala_dinas" placeholder="Nip Kepala Dinas" value="<?php echo $_POST["nip_kepala_dinas"];?>">
							 			</div>
							 			<div class="form-group">
							 				<input class="form-control" type="" name="keterangan_lain" placeholder="Keterangan Lain" value="<?php echo $_POST["keterangan_lain"];?>">
							 			</div>
									</div>
								</div>
					 		</fieldset>
